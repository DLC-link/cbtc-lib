...
**Note:** cbtc-lib underwent a major restructure in December 2025 (v0.0.1 tag). Update your dependencies if using an earlier version. See the [cleanup PR](https://github.com/DLC-link/cbtc-lib/pull/11).
