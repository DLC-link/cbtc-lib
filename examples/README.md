...
**Step 12: List outgoing offers (sender)**
...
**Step 15: Check receiver balance**
...
**Step 17: Accept transfers (sender)**
- **Given** the sender has a pending incoming offer from step 16
- **When** calling `accept_all` for the sender party
- **Then** all offers are accepted with zero failures

**Step 18: Check sender balance (pre-withdraw)**
...
**Step 20: Check balance (post-withdraw)**
...
**Step 21: Consolidate UTXOs (sender)**
